        ...
        _process_trial_balance: function (report_lines) {
            ...
            for (var l=0;l<report_lines.length;l++) {
                if (report_lines[l].line_type != 'journal_item') {
                    ...
                    this.report_lines[0]['initial_balance'] += report_lines[l].initial_balance;
                    this.report_lines[0]['closing_balance'] += report_lines[l].closing_balance;
                }
            }
...
//                }
        ...
        _build_root_line_html: function (r_line) {
            ...
            if (report_id == 'trial_balance') {
                var cols = ['debit', 'credit', 'balance','initial_balance', 'closing_balance'];
                for (var i in cols) {
